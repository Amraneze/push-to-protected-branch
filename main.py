...
if __name__ == '__main__':
    ...
    repository = github.get_user(os.getenv("INPUT_GITHUB_USER") or GithubObject.NotSet).get_repo(os.getenv("INPUT_REPOSITORY"))
    ...
    if os.getenv("INPUT_CREATE_TAG"):
        repository.create_git_ref(f'refs/tags/{os.getenv("INPUT_TAG_VERSION")}', origin_sha)
    ...
    commit = repository.create_git_commit(os.getenv("INPUT_COMMIT_MESSAGE"), tree, [parent])
